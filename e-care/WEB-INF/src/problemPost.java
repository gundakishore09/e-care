...
public class problemPost extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        {
            Date date = new Date();
			s6=(String)httpsession.getValue("user");
			System.out.println("User_Id : " +s6);
            String s1 = httpservletrequest.getParameter("select1");
			System.out.println("Category Id:" +s1);
            String s3 = httpservletrequest.getParameter("select2");
			System.out.println("Module Id:" +s3);
            ...
            } else
            {
                ...
                if(k == 0)
                    ...
                    k++;
				System.out.println("Ticket is " +k);
                String s17 = "null";
                String s18 = "unfinished";
                String s19 = "";
                String s20 = "";
                String s21 = "";
				String query="insert into problemrequest( TICKET, CATEGORYID, MODULEID, PROBLEMDESCRIPTION,LASTSOLUTION, USER_ID, PROBLEMREPORTDATE)  values('" + k + "','" + s1 + "','" + s3 + "','" + s5 + "','" + s17 + "','" + s6 + "','" + s15 + "')";
				System.out.println("Query is :" +query);
                int l = st1.executeUpdate(query);
				System.out.println("Prepared Statement is Executed" +l);
                if(l == 1)
                {
					String query1="insert into problemhistory values('" + k + "','" + s15 + "','" + s5 + "','" + s19 + "','" + s20 + "','" + s6 + "','" + s18 + "')";
					System.out.println("Query1 is :" +query1);
                    int i1 = st.executeUpdate(query1);
					System.out.println("Prepared Statement is Executed" +i1);
                    printwriter.println("<HTML>");
                    printwriter.println("<HEAD><TITLE></TITLE>");
                    printwriter.println("<script language = 'JavaScript'>");
                    printwriter.println("</script>");
                    printwriter.println("<BODY>");
                    printwriter.println("<form name=f1 action='./corporateclientview.html' target='_parent'>");
