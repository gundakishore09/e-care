...
public class clientprofile extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            for(rs = st.executeQuery("select * from registration where ctype='" + s20 + "'"); rs.next();)
            {
                System.out.println("inside client PROFILE");
                s = rs.getString(1);
            ...
            printwriter.println("document.f.action='./corporateclientview.html';");
            printwriter.println("document.f.submit();");
            printwriter.println("}");
            printwriter.println("</script>");
            printwriter.println("<BODY>");
            printwriter.println("<form name=f target='_parent'>");
            printwriter.println("<P align=center><FONT color=forestgreen ");
            printwriter.println("size=6><STRONG>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
            printwriter.println("&nbsp;&nbsp; ");
            printwriter.println("<U>Client Profile</U></STRONG></FONT></P>");
