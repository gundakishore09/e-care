...
public class level3profile extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        String s20 = (String)httpsession.getValue("third");
        System.out.println("inside servicemethod");
        try
        {
            System.out.println("inside servicetry");
            rs = st.executeQuery("select * from hdemp1 where levelname='" + s21 + "'");
            if(rs.next())
            {
            ...
            printwriter.println("<form name=f action='./thirdleveladministrator.html'target='_parent'>");
