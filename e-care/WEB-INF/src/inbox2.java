...
public class inbox2 extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            rs = st.executeQuery("select * from level2messages");
            ...
            for(; rs.next(); printwriter.println(" <TD>&nbsp;&nbsp;" + s2 + "&nbsp;&nbsp;</TD> "))
            {
                ...
                printwriter.println(" <TR> ");
                printwriter.println(" <TD><a href='./messagefrom2?fnam=" + s + "&des=" + s3 + "'>" + s + "</a>&nbsp;&nbsp;</TD> ");
            ...
            printwriter.println("<TD>&nbsp;<a href='./message2.html'>Go Back to Messages</a></TD></TR>");
            printwriter.println("</P> ");
            printwriter.println("</form>");
            printwriter.println("</body>");
            printwriter.println("</html>");
